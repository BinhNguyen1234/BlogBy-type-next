...
export default memo(function SendBlogBtn({onClick }:Props):ReactElement{
    ...
    return (<>
        ...
        <button id={Style.SendBlogBtn} onClick={onClick} disabled={stateBtn.isDisable} type="button" className={`btn ${stateBtn.color}`}>
        <span style={{display:stateBtn.spinnerIsHide}}  className="spinner-border text-light" role="status"></span>
