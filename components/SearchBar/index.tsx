            ...
            <form id={Style.SearchBar}>
                ...
                {filter?
                    <div className="dropdown ">
                        <button style={{"borderRadius":"0","borderRight":"1px solid black"}} className="btn btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Filter
                        </button>
                ...
                null}
                <button type="button" className="btn btn-primary" ><span>&#128270;</span><span>Find</span></button>
            </form>
        </>
    )
}
